...
export const imports = {
    wbg: {
        ...
        __wbg_call_672a4d21634d4a24: (...args) => {
        ...
        __wbg_createElement_8c9931a732ee2fea: (...args) => {
        ...
        __wbg_sethref_7eb69a6b9ae98056: (...args) => {
        ...
        __wbg_then_44b73946d2fb3e7d: (...args) => {
        ...
        __wbindgen_debug_string: (...args) => {
            console.trace("__wbindgen_debug_string", args);
        },
        __wbindgen_init_externref_table: (...args) => {
